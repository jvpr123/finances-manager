...
import { DeleteTransactionController } from "./DeleteTransaction.controller";
import {
  internalServerError,
  notFound,
  ok,
...
const makeUseCaseStub = (): IDeleteTransactionUseCase => ({
  execute: resolveValue(true),
});

const makeSUT = (useCase: IDeleteTransactionUseCase): IController =>
  new DeleteTransactionController(useCase);

describe("Delete Transaction Controller", () => {
  let sut: IController;
  let useCase: IDeleteTransactionUseCase;
  ...
  describe("Dependency: DeleteTransactionUseCase", () => {
