...
const makeUseCaseStub = (): IDeleteCategoryUseCase => ({
  execute: resolveValue(true),
});

const makeSUT = (useCase: IDeleteCategoryUseCase): IController =>
  new DeleteCategoryController(useCase);

describe("Delete Category Controller", () => {
  let sut: IController;
  let useCase: IDeleteCategoryUseCase;
  ...
  describe("Dependency: DeleteCategoryUseCase", () => {
